...
#' @param stampArgs list, list of paramater values to provide to the \code{stamp} function
#'
#' @return
...
stamp.multichange <- function(polys, changeByRow=TRUE, changeByField = FALSE, changeField="", stampArgs=list()) {
  outEvents <- list()
  lSum <- 1
  if(changeByRow==TRUE) {
